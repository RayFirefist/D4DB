        ...
        return <div>
            ...
            <Grid container spacing={2}>
                ...
                <Grid item xs={6}>
                    ...
                    <Card>
                        {this.state.gacha.map(gacha => <a href={"/gacha/" + gacha.Id}><div style={{ padding: "20px" }}>
                            <ImageLoader
                                src={consts.cdn + "ondemand/banner/banner_gacha_{0}.png".format(gacha.Id.toString().padStart(4, "0"))}
                                style={{ width: "100%" }}
                            />
                            <br />
                            <h2>{gacha.Name}</h2>
